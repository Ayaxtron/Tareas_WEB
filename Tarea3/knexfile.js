...
module.exports = {
  development: {
    ...
    connection: {
      ...
      database: process.env.DB_DEVELOPMENT_NAME || 'node_crud4',
      user:  process.env.DB_DEVELOPMENT_USER || 'root',
      password: process.env.DB_DEVELOPMENT_PASSWORD || '16deagostode1998'
    },
    pool: {
      min: 2,
      max: 10
  ...
  production: {
    ...
    connection: {
      ...
      database: process.env.DB_PRODUCTION_NAME || 'node_crud4',
      user:  process.env.DB_PRODUCTION_USER || 'root',
      password: process.env.DB_PRODUCTION_PASSWORD || '16deagostode1998'
    },
    pool: {
      min: 2,
      max: 10
